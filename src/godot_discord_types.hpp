...
#define GODOT_DISCORD_TYPE_UINT_32 std::uint32_t
...
#define GODOT_DISCORD_TYPE_ImageType discord::ImageType
...
#define OAUTH2_TOKEN_BIND_MACROS(ClassName) \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_STRING, accessToken, "") \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_STRING, scopes, "") \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_Timestamp, expires, 0) \

#define OAUTH2_TOKEN_VARIABLE_MACROS \
    GODOT_VARIABLE_GET_SET_STRING(accessToken, GetAccessToken, SetAccessToken) \
    GODOT_VARIABLE_GET_SET_STRING(scopes, GetScopes, SetScopes) \
    GODOT_VARIABLE_GET_SET_VAL(expires, GODOT_DISCORD_TYPE_Timestamp, GODOT_DISCORD_TYPE_Timestamp, GetExpires, SetExpires) \


GODOT_DISCORD_DEFINE(OAuth2Token, OAUTH2_TOKEN_VARIABLE_MACROS, OAUTH2_TOKEN_BIND_MACROS)

// Image

#define IMAGE_HANDLE_BIND_MACROS(ClassName) \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_INT_64, type, 0) \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_INT_64, id, 0) \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_UINT_32, size, 0) \

#define IMAGE_HANDLE_VARIABLE_MACROS \
    GODOT_VARIABLE_GET_SET_VAL(type, GODOT_DISCORD_TYPE_INT_64, GODOT_DISCORD_TYPE_ImageType, GetType, SetType) \
    GODOT_VARIABLE_GET_SET_VAL(id, GODOT_DISCORD_TYPE_INT_64, GODOT_DISCORD_TYPE_INT_64, GetId, SetId) \
    GODOT_VARIABLE_GET_SET_VAL(size, GODOT_DISCORD_TYPE_UINT_32, GODOT_DISCORD_TYPE_UINT_32, GetSize, SetSize) \


GODOT_DISCORD_DEFINE(ImageHandle, IMAGE_HANDLE_VARIABLE_MACROS, IMAGE_HANDLE_BIND_MACROS)

#define IMAGE_DIMENSIONS_BIND_MACROS(ClassName) \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_INT_64, width, 0) \
    GODOT_VAL_BINDING(ClassName, GODOT_DISCORD_TYPE_INT_64, height, 0) \

#define IMAGE_DIMENSIONS_VARIABLE_MACROS \
    GODOT_VARIABLE_GET_SET_VAL(width, GODOT_DISCORD_TYPE_INT_64, GODOT_DISCORD_TYPE_INT_64, GetWidth, SetWidth) \
    GODOT_VARIABLE_GET_SET_VAL(height, GODOT_DISCORD_TYPE_INT_64, GODOT_DISCORD_TYPE_INT_64, GetHeight, SetHeight) \


GODOT_DISCORD_DEFINE(ImageDimensions, IMAGE_DIMENSIONS_VARIABLE_MACROS, IMAGE_DIMENSIONS_BIND_MACROS)
